...
function eeSFL_BASE_ManageLists() {
	...
	if(!is_array($eeSFL_Settings) OR !is_array($eeSFL_BASE_Env)) {
		$eeSFL_BASE_Log['errors'][] = 'No SFL Configuration';
		return FALSE;
	}
	...
	// File List
	$eeOutput .= '<a href="?page=' . $eeSFL_BASE->eePluginSlug . '&tab=file_list" class="nav-tab tabList ';  
    ...
    // Author
    $eeOutput .= '<a href="?page=' . $eeSFL_BASE->eePluginSlug . '&tab=author" class="nav-tab tabSupport ';   
    ...
    // Settings
    $eeOutput .= '<a href="?page=' . $eeSFL_BASE->eePluginSlug . '&tab=settings" class="nav-tab tabSettings ';   
    ...
    // Shortcode Builder
    $eeOutput .= '<a href="?page=' . $eeSFL_BASE->eePluginSlug . '&tab=shortcode" class="nav-tab tabSettings ';  
    ...
    $eeOutput .= '<a href="?page=' . $eeSFL_BASE->eePluginSlug . '&tab=pro" class="nav-tab tabSupport ';   
